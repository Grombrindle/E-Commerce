              ...
              <div class="w-full pr-2 lg:w-1/4 lg:block">
                  ...
                  <ul>
                    ...
                    <li class="mb-4">
                      <label for="On Sale" class="flex items-center dark:text-gray-300">
                        <input type="checkbox" id="On Sale" wire:model.live='On_Sale' value="1" class="w-4 h-4 mr-2">
                ...
                <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                  ...
                  <div>
                    ...
                    <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="10000" value="5000" step="10">
                    <div class="flex justify-between ">
                      <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(0, 'USD') }}</span>
                        ...
                        <div class="border border-gray-300 dark:border-gray-700">
                          <div class="relative bg-gray-200">
                            <a href="/products/{{ $product->slug }}" class="">
                                <img src="{{ Storage::url($product->images[0]) }}" alt="Product image" class="object-cover w-full h-56 mx-auto">
                            </a>
                          </div>
                          <div class="p-3 ">
